...
.L27:
	...
	vcvtsi2sd	%r13d, %xmm18, %xmm18
	vmovsd	.LC3(%rip), %xmm20
	vmovsd	%xmm18, 8(%rsp)
	vmulsd	%xmm18, %xmm20, %xmm0
	vmulsd	(%rsp), %xmm0, %xmm0
	call	sin@PLT
	vmovsd	%xmm0, 24(%rsp)
	vmovsd	.LC5(%rip), %xmm21
	vmulsd	8(%rsp), %xmm21, %xmm0
	vmulsd	(%rsp), %xmm0, %xmm0
	call	sin@PLT
	vmovsd	%xmm0, 32(%rsp)
	movl	$0, %ebx
